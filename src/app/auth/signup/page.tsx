...
export default function SignUpPage({ className }: { className?: string }) {
  return (
    <div className="flex min-h-svh gridAnim flex-col items-center justify-center gap-6 bg-background p-6 md:p-10">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col items-center gap-2">
              <a href="#" className="flex flex-col items-center gap-2 font-medium">
                ...
                <span className="sr-only">Delta Mascots</span>
              </a>
              <h1 className="text-xl font-bold">Welcome to Delta Mascots</h1>
